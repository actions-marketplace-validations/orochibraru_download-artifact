...
import { DigestMismatchBehavior, Inputs, Outputs } from "./constants.js";
...
export async function run(): Promise<void> {
	const inputs = {
		...
		runID: parseInt(core.getInput(Inputs.RunID, { required: false }), 10),
		...
		digestMismatch: (core.getInput(Inputs.DigestMismatch, {
			required: false,
